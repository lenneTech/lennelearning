...
export class JobInterestedPageComponent implements OnInit {
  ...
  subtitle =
    'Lerne bei uns die Berufsfelder rund um die Entwicklung von modernen Anwendungen kennen.\n Gewinne in einem kurzen Praktikum einen Einblick in den Berufsalltag in der Softwareentwicklung und lerne dabei schonmal grundlegende Aspekte der Webentwicklung kennen.';
